    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="mb-8">
            <div class="flex items-center mb-2">
                ...
                <h1 class="text-3xl font-bold">Edit Gallery Product</h1>
            </div>
            <p class="text-gray-400">Update the details for this product</p>
        </div>
        ...
        <!-- Form -->
        <form action="{{ route('admin.gallery.update', $product->id) }}" 
              method="POST" 
            ...
            <div class="mb-6">
                ...
                <p class="mt-2 text-sm text-gray-400">
                    <span id="charCount">{{ strlen($product->description) }}</span> / 500 characters
                </p>
                @error('description')
                    <p class="mt-2 text-sm text-red-400">{{ $message }}</p>
                @enderror
            ...
            <div class="mb-6">
                <label for="image" class="block text-sm font-medium mb-2">
                    @if ($product->image) Replace Image @else Product Image @endif
                </label>
